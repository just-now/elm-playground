...
var author$project$HW1$compress = function (s) {
	var comp = F3(
		function (prev, first, list) {
			comp:
			while (true) {
				if (!list.b) {
					return _List_Nil;
					...
					var x = list.a;
					var xs = list.b;
					var _n1 = first || (!_Utils_eq(prev, x));
					if (_n1) {
						return A2(
							elm$core$List$cons,
							x,
...
var author$project$HW1$dropEvery = F2(
	function (s, i) {
		var drop = F2(
			function (idx, list) {
				drop:
...
var author$project$HW1$myReverse = function (list) {
	var rev = F2(
		function (li, ret) {
			rev:
			while (true) {
				if (!li.b) {
					...
					var xs = li.b;
					var $temp$li = xs,
						$temp$ret = A2(elm$core$List$cons, x, ret);
					li = $temp$li;
					ret = $temp$ret;
					continue rev;
				}
	...
	return A2(rev, list, _List_Nil);
};
var author$project$HW1$isPalindrome = function (li) {
	var lieq = F2(
		function (left, right) {
	...
	return A2(
		lieq,
		li,
		author$project$HW1$myReverse(li));
};
var author$project$HW1$myButLast = function (l) {
	myButLast:
	while (true) {
		if (!l.b) {
			return elm$core$Maybe$Nothing;
...
var author$project$HW1$myLast = function (l) {
	myLast:
	while (true) {
		if (!l.b) {
			return elm$core$Maybe$Nothing;
...
var author$project$HW1$myLength = function (list) {
	if (!list.b) {
		return 0;
	} else {
		var xs = list.b;
		return 1 + author$project$HW1$myLength(xs);
	}
};
		...
		[
			...
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					author$project$HW1$myLast(_List_Nil));
			}),
			A2(
			elm_explorations$test$Test$test,
			'myLast-one',
			...
			function (_n4) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Maybe$Nothing,
					author$project$HW1$myButLast(_List_Nil));
			}),
			A2(
			elm_explorations$test$Test$test,
			'myButLast-1',
			...
			function (_n10) {
				return A2(
					elm_explorations$test$Expect$equal,
					true,
					author$project$HW1$isPalindrome(
						_List_fromArray(
							[1, 2, 4, 8, 16, 8, 4, 2, 1])));
			}),
			A2(
			...
			function (_n12) {
				return A2(
					elm_explorations$test$Expect$equal,
					'abcade',
					author$project$HW1$compress('aaaabccaadeeee'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'dropEvery',
			function (_n13) {
				return A2(
					elm_explorations$test$Expect$equal,
					'abdeghk',
					A2(author$project$HW1$dropEvery, 'abcdefghik', 3));
			}),
			A3(
...
var author$project$HW2$bird = function () {
	var notThree = function (x) {
		return x !== 3;
	};
	var incr = function (x) {
		return x + 1;
...
var author$project$HW2$bird2 = function () {
	var notThree = function (x) {
		return x !== 3;
	};
	var incr = function (x) {
...
var author$project$HW2$bird3 = function () {
	var notThree = function (x) {
		return x !== 3;
	};
	var incr = function (x) {
...
var author$project$HW2$convert02 = A2(
	elm$core$Basics$composeR,
	elm$core$List$filter(
		function (x) {
			return !(_Utils_eq(x.name, elm$core$Maybe$Nothing) || _Utils_eq(x.email, elm$core$Maybe$Nothing));
		}),
	elm$core$List$map(
		function (ne) {
			return {
				email: A2(elm$core$Maybe$withDefault, '', ne.email),
				name: A2(elm$core$Maybe$withDefault, '', ne.name)
			};
		}));
var author$project$HW2$convert03 = A2(
	elm$core$Basics$composeR,
	elm$core$List$filter(
		function (x) {
			return !_Utils_eq(x.name, elm$core$Maybe$Nothing);
		}),
	elm$core$List$map(
		function (ne) {
			return {
				email: A2(elm$core$Maybe$withDefault, '<unspecified>', ne.email),
				name: A2(elm$core$Maybe$withDefault, '', ne.name)
			};
		}));
		...
		[
			...
			function (_n0) {
				return A2(
					...
					author$project$HW2$convert(
						_List_fromArray(
							[
								{email: 'john@gmail.com', name: 'John', phone_number: '+3801234567'}
							])));
			}),
			A2(
			elm_explorations$test$Test$test,
			...
			function (_n1) {
				return A2(
					...
					author$project$HW2$convert02(
						_List_fromArray(
							[
								{
								email: elm$core$Maybe$Just('john@gmail.com'),
								name: elm$core$Maybe$Just('John')
							},
								{
								email: elm$core$Maybe$Just('xxx@'),
								name: elm$core$Maybe$Nothing
							},
								{
								email: elm$core$Maybe$Nothing,
								name: elm$core$Maybe$Just('x')
							}
							])));
			}),
			A2(
			...
			'bird2',
			function (_n3) {
				return A2(elm_explorations$test$Expect$equal, author$project$HW2$bird, author$project$HW2$bird2);
			}),
			A2(
			elm_explorations$test$Test$test,
			'bird3',
...
var author$project$HW4$decodeCountryData = A3(
	elm$json$Json$Decode$map2,
	F2(
		function (motto, currency) {
			return {currency: currency, motto: motto};
		}),
	A2(elm$json$Json$Decode$field, 'motto', elm$json$Json$Decode$string),
...
var author$project$HW4$decodeUser = A3(
	elm$json$Json$Decode$map2,
	F2(
		function (name, cats) {
			return {cats: cats, name: name};
		}),
...
var author$project$HW4$AccountInfo = F5(
	function (id, email, full_name, phone_number, info_complete) {
		return {email: email, full_name: full_name, id: id, info_complete: info_complete, phone_number: phone_number};
	});
...
var author$project$HW4$jsonDecAccountInfo = A3(
		...
		A3(
			...
			A3(
				...
				A3(
					...
					elm$json$Json$Decode$succeed(author$project$HW4$AccountInfo))))));
var author$project$HW5$Num = function (a) {
	return {$: 'Num', a: a};
};
var author$project$HW5$Obj = function (a) {
	return {$: 'Obj', a: a};
};
var author$project$HW5$decodeValue = F2(
	function (_n0, v) {
		var f = _n0.a;
		return f(v);
	});
var author$project$HW5$MyJsonDecoder = function (a) {
	return {$: 'MyJsonDecoder', a: a};
};
...
var author$project$HW5$myJsonField = F2(
	function (key, _n0) {
		var f = _n0.a;
		return author$project$HW5$MyJsonDecoder(
			function (v) {
				if (v.$ === 'Obj') {
					var x = v.a;
					return A2(
						...
						A2(
							...
							A2(
								elm$core$Dict$get,
								key,
								elm$core$Dict$fromList(x))));
				} else {
					return elm$core$Result$Err('!field');
				}
			});
	});
var author$project$HW5$myJsonInt = author$project$HW5$MyJsonDecoder(
	function (v) {
		if (v.$ === 'Num') {
			var x = v.a;
			return elm$core$Result$Ok(x);
		} else {
			return elm$core$Result$Err('!int');
		}
	});
var elm$json$Json$Decode$decodeString = _Json_runOnString;
var author$project$Example4$suite = A2(
	elm_explorations$test$Test$describe,
	'Home Work #4',
	_List_fromArray(
		[
			...
			function (_n0) {
				return A2(
					...
					elm$core$Result$Ok(
						{
							cats: elm$core$Maybe$Just(2),
							name: 'Kostia'
						}),
					A2(elm$json$Json$Decode$decodeString, author$project$HW4$decodeUser, '{\"name\": \"Kostia\", \"cats\": 2}'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'decode2',
			function (_n1) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Result$Ok(
						{cats: elm$core$Maybe$Nothing, name: 'Droopy ..'}),
					A2(elm$json$Json$Decode$decodeString, author$project$HW4$decodeUser, '{\"name\": \"Droopy ..\", \"cats\": null}'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'decode3',
			function (_n2) {
				return A2(
					elm_explorations$test$Expect$equal,
					elm$core$Result$Ok(
						{currency: 'EUR', motto: 'Einigkeit und ..'}),
					A2(elm$json$Json$Decode$decodeString, author$project$HW4$decodeCountryData, '{"motto": "Einigkeit und ..", "currency": "EUR"}'));
			}),
			A2(
			elm_explorations$test$Test$test,
			'decode5',
			function (_n3) {
				return A2(
					...
					elm$core$Result$Ok(
						{
							email: 'bb@u.net',
							full_name: elm$core$Maybe$Just('A'),
							id: 1,
							info_complete: true,
							phone_number: elm$core$Maybe$Just('555')
						}),
					A2(elm$json$Json$Decode$decodeString, author$project$HW4$jsonDecAccountInfo, author$project$HW4$accInfo));
			}),
			A2(
			elm_explorations$test$Test$test,
			'my-decode-1',
			function (_n4) {
				return A2(
					...
					A2(
						author$project$HW5$decodeValue,
						author$project$HW5$myJsonInt,
						author$project$HW5$Num(4)));
			}),
			A2(
			elm_explorations$test$Test$test,
			'my-decode-2',
			function (_n5) {
				return A2(
					...
					A2(
						author$project$HW5$decodeValue,
						A2(author$project$HW5$myJsonField, 'foo', author$project$HW5$myJsonInt),
						author$project$HW5$Obj(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'foo',
...
var author$project$Test$Generated$Main969409246$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/anatoliy/Private/elm/tests/Example.elm', '/Users/anatoliy/Private/elm/tests/Example2.elm', '/Users/anatoliy/Private/elm/tests/Example3.elm', '/Users/anatoliy/Private/elm/tests/Example4.elm']),
		processes: 4,
...
_Platform_export({'Test':{'Generated':{'Main969409246':{'init':author$project$Test$Generated$Main969409246$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-74052.sock";
